		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
					...
					html += '	<h3>新建应提交资源记录</h3>';
					html += '	<div class="labels"><label>授课教师:</label><input type="text" /></div>';
					html += '	<div class="labels"><label>教师ID:</label><input type="text" /></div>';
					html += '	<div class="labels"><label>课程名称:</label><input type="text" /></div>';
					html += '	<div class="needs">';
					html += '		<label>课程概况：</label><select><option>需要</option><option>不需要</option></select>';		
					html += '		<label>课程学习：</label><select><option>需要</option><option>不需要</option></select>';	
					html += '		<label>媒体素材：</label><select><option>需要</option><option>不需要</option></select>';	
					html += '		<label>实验：</label><select><option>需要</option><option>不需要</option></select>';		
					html += '		<label>作业：</label><select><option>需要</option><option>不需要</option></select>';	
					html += '		<label>考试：</label><select><option>需要</option><option>不需要</option></select>';	
					html += '	</div>';
					html += '	<div class="buttons">';
					html += '	<button type="submit">确定</button><button type="reset">取消</button>';	
					html += '	</div>';
					html += '	</div>';
					html += '</form>';
				}else{

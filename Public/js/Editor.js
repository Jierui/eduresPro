...
this.toolbar = create("div",this._body); //������ 
this.iframe = create("iframe",this._body); //�༭�� 
this.textarea = create("textarea",this._body); //��ʾԴ����Ŀ�� 
this.bottom = create("div",this._body); //�ײ� 
this.lightbox = b; //lightbox 
this.original = create("input"); //��ʾԴ����İ�Ŧ 
this.ed = null; 
this.isfocus = false; 
this.option = {}; 
...
Attr(this.iframe,{src:"about:blank",width:Sys.IE?this.option.width:this.option.width-4,height:Sys.IE?this.option.height-40:this.option.height-40}); 
Attr(this.original,{type:"checkbox",className:"checkbox",align:"top"}); 
this.bottom.className = "bottom"; 
this.bottom.innerHTML = "<span>��ʾԴ����</span>"; 
...
{ 
var size = new popoup({width:"210px",title:"�ֺ�"}),a; 
...
{ 
var name = new popoup({width:"200px",title:"����"}),a; 
...
this[n].pos(); 
$$(this[n].container,"div")[1].innerHTML = "<div style=' margin-top:6px;padding-bottom:5px;'>��<input type='file' value='ѡ��' /><br><input style='float:right;margin-right:5px;margin-bottom:5px;' type='button' value='ȷ��' /></div>" 
this[n].elm = [$$(this[n].container," ")[0],$$(this[n].container,"input")[0],$$(this[n].container,"input")[1]]; 
this[n].elm[0].focus() 
addListener(this[n].elm[0],'click',Bind(this,this.Execa,null,f)); 
addListener(this[n].elm[1],'click',function(){self.lightbox.Close();self[n].Close();}); 
} 
else 
...
var data = [{Class:"span0",hover:"span0_hover",title:"�Ӵ�",action:"Exec",args:"bold"}, 
{Class:"span1",hover:"span1_hover",title:"б��",action:"Exec",args:"Italic"}, 
{Class:"span2",hover:"span2_hover",title:"�»���",action:"Exec",args:"Underline"}, 
{Class:"span3",hover:"span3_hover",title:"�ֺ�",action:"Fontsize",args:null}, 
{Class:"span4",hover:"span4_hover",title:"����",action:"FontName",args:null}, 
{Class:"span5",hover:"span5_hover",title:"������ɫ",action:"Fontcolor",args:null}, 
{Class:"span6",hover:"span6_hover",title:"��������",action:"CreateLink",args:null}, 
{Class:"span7",hover:"span7_hover",title:"����",action:"Exec",args:"Cut"}, 
{Class:"span8",hover:"span8_hover",title:"����",action:"Exec",args:"Copy"}, 
{Class:"span9",hover:"span9_hover",title:"�����",action:"Exec",args:"JustifyLeft"}, 
{Class:"span10",hover:"span10_hover",title:"���ж���",action:"Exec",args:"JustifyCenter"}, 
{Class:"span11",hover:"span11_hover",title:"�Ҷ���",action:"Exec",args:"JustifyRight"}, 
{Class:"span12",hover:"span12_hover",title:"��Ŀ����",action:"Exec",args:"InsertUnorderedList"}, 
{Class:"span13",hover:"span13_hover",title:"���",action:"Exec",args:"InsertOrderedList"}, 
{Class:"span14",hover:"span14_hover",title:"������",action:"Addtable",args:null}, 
{Class:"span15",hover:"span15_hover",title:"��������",action:"Exec",args:"Outdent"}, 
{Class:"span16",hover:"span16_hover",title:"��������",action:"Exec",args:"Indent"}, 
{Class:"span17",hover:"span17_hover",title:"�����ʽ",action:"Exec",args:"RemoveFormat"}, 
{Class:"span18",hover:"span18_hover",title:"����ͼƬ",action:"InsertImage",args:null}, 
{Class:"span19",hover:"span19_hover",title:"�������",action:"Expression",args:null}, 
{Class:"span20",hover:"span20_hover",title:"�Զ��Ű�",action:"Layout",args:null} 
]; 
